...
Supports Hindi and English with configurable voices
"""
...
app = FastAPI(
    ...
    version="1.0.0",
    description="Production-ready text-to-speech service with real-time streaming and multi-language support (Hindi & English)"
)
...
async def startup_event():
    ...
    logger.info("=" * 60)
    logger.info("Piper TTS Service v1.0.0")
    logger.info("=" * 60)
...
async def list_voices():
    ...
    Returns:
        List of available voice configurations for Hindi and English
    """
