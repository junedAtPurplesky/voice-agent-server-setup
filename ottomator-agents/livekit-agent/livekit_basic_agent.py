...
from custom_plugins import STT, LLM, TTS
...
async def entrypoint(ctx: agents.JobContext):
    ...
    # Configure the voice pipeline with custom deployed services
    session = AgentSession(
        stt=STT(language="en"),
        llm=LLM(model=os.getenv("LLM_MODEL", "default")),
        tts=TTS(voice=os.getenv("TTS_VOICE", "default")),
        vad=silero.VAD.load(),
    )
